...
public class TutorialMap extends GameMap {
	...
	public void render(Graphics2D g) {
		...
		g.drawImage(Resource.skyUppercutContent, null, 8250 - gameScreen.getCameraX(), 780 - gameScreen.getCameraY());
		g.drawImage(Resource.eButton, null, 9500 - gameScreen.getCameraX(), 750 - gameScreen.getCameraY());
		g.drawImage(Resource.concentrationContent, null, 9470 - gameScreen.getCameraX(), 730 - gameScreen.getCameraY());
